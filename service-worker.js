...
// --- DEFINITIVE FIX: Updated cache version to force a hard refresh and clear stale caches ---
const CACHE_NAME = 'gym-log-pro-v1.4-hotfix'; // อัปเดตเวอร์ชัน Cache เพื่อบังคับให้ติดตั้งใหม่ทั้งหมด
